...
module.exports = class KubeClass {
  ...
  async getCoreApis() {
    let coreApiList = await RequestLib.doRequest(merge(this._baseOptions, {uri: '/api/v1', method: 'get'}));
  ...
  async getApis(getAll = false) {
    let apiQuery = await RequestLib.doRequest(merge(this._baseOptions, {uri: '/apis', method: 'get'}));
  ...
  async getApisSingle(groupVersion, krmHandler) {
    let response = await RequestLib.doRequest(merge(this._baseOptions, {uri: '/apis/' + groupVersion, method: 'get'}));
  ...
  async getResource(resourceMeta, queryParams = {}) {
    ...
    let response = await RequestLib.doRequest(merge(options, {uri: resourceMeta.uri(), method: 'get'}));
  ...
  async getKubeResourcesMeta(verb) {
    ...
    try {
      const crdsHash = {};
      let response = await RequestLib.doRequest(merge(this._baseOptions, {uri: '/apis/apiextensions.k8s.io/v1/customresourcedefinitions', method: 'get'}));
