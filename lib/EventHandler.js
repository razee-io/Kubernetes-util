...
module.exports = class EventHandler {
  constructor(params = {}) {
    ...
    if (params._livenessInterval) {
      if (Number.isInteger(params._livenessInterval)) {
        this._livenessInterval = params._livenessInterval;
      } else if (String(params._livenessInterval) === 'true') {
