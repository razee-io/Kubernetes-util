...
module.exports = class Watchman {
  ...
  async watch() {
    ...
    const axiosOptions = merge.all([KubeApiConfig(), this._requestOptions, { baseURL: this._requestOptions.baseUrl, url: this._requestOptions.uri, responseType: 'stream' }]); // request: baseUrl/uri, axios: baseURL/url/responseType
