...
module.exports = class Watchman {
  constructor(options, objectHandler, kubeResourceMeta) {
    if ((typeof objectHandler) !== 'function') {
      throw 'Watchman objectHandler must be a function.';
    }
    if ((typeof kubeResourceMeta.uri) !== 'function') {
      throw 'Watchman kubeResourceMeta.uri() must be a function.';
    }
    this._objectHandler = objectHandler;
    this._kubeResourceMeta = kubeResourceMeta;
